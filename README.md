...
<head>
    ...
    <title>Sistema de cobranças Felka</title>
    <style>
        :root {
            --bg-color: #f8fbff;
            --text-color: #2c3e50;
            --container-bg: linear-gradient(135deg, #ffffff 0%, #f0f4f8 100%);
            --section-bg: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%);
            --result-bg: linear-gradient(135deg, #e3f2fd 0%, #bbdefb 100%);
            --tribut-bg: linear-gradient(135deg, #e8f5e8 0%, #c8e6c9 100%);
            --frete-bg: linear-gradient(135deg, #ffebee 0%, #ffcdd2 100%);
            --border-color: #e0e6ed;
            --header-color: #1a202c;
            --accent-color: #4299e1;
            --highlight-bg: linear-gradient(135deg, #fff9c4 0%, #fff176 100%);
            --success-bg: linear-gradient(135deg, #c8e6c9 0%, #a5d6a7 100%);
            --error-color: #e53e3e;
            ...
            --table-even: rgba(248, 249, 250, 0.5);
        }
     
        [data-theme="dark"] {
            --bg-color: #000000;
            --text-color: #ffffff;
            --container-bg: linear-gradient(135deg, #0a1428 0%, #1a2332 100%);
            --section-bg: linear-gradient(135deg, #0a1428 0%, #1a2a3a 100%);
            --result-bg: linear-gradient(135deg, #0f1a2b 0%, #1a2b3a 100%);
            --tribut-bg: linear-gradient(135deg, #0a2f1a 0%, #1b5e20 100%);
            --frete-bg: linear-gradient(135deg, #4a0a0a 0%, #7f1d1d 100%);
            --border-color: #1a2a3a;
            --header-color: #ffffff;
            --accent-color: #add8e6;
            --highlight-bg: linear-gradient(135deg, #5d2a0a 0%, #8d5524 100%);
            --success-bg: linear-gradient(135deg, #0a2f1a 0%, #1b5e20 100%);
            --shadow-sm: 0 1px 3px rgba(0, 0, 0, 0.5);
            --shadow-md: 0 4px 6px rgba(0, 0, 0, 0.5);
            --shadow-lg: 0 10px 15px rgba(0, 0, 0, 0.5);
            --input-bg: rgba(10, 20, 40, 0.8);
            --card-bg: rgba(26, 42, 58, 0.7);
            --table-even: rgba(26, 42, 58, 0.5);
        }
        ...
        * {
        ...
        .input-section:hover, .tribut-section:hover, .frete-section:hover {
        ...
        button {
            padding: 10px 16px;
            background: linear-gradient(135deg, var(--accent-color) 0%, #87ceeb 100%);
            color: #000000;
            border: none;
            border-radius: var(--border-radius-sm);
            font-size: 12px;
        ...
        .new-client-btn:hover {
            background: linear-gradient(135deg, #148a9b 0%, #117a8b 100%);
        }
        .client-section {
            margin-bottom: 25px;
            padding: 20px;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function handleRotaChange() {
                ...
                if (dadosRota.origem && nomeCliente) {
                    ...
                    veiculosRota.forEach(veiculo => {
                        ...
                        option.textContent = `${veiculo.tipo} (${veiculo.capacidade}) - ADV: ${parseFloat(veiculo.adv).toFixed(2).replace('.', ',')}%`;
            ...
            function toggleTheme() {
                ...
                document.querySelectorAll('.editing input').forEach(input => {
                    input.style.backgroundColor = newTheme === 'dark' ? '#1e293b' : 'white';
                    input.style.color = newTheme === 'dark' ? '#f1f5f9' : 'black';
                });
            }
